<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SearchCrit.aspx.cs" Inherits="ETH_GV.FramePages.SearchCrit" EnableSessionState="False" EnableViewState="false"  %>
<%
...
<head id="Head1" runat="server">
    <title>Search:Full Title Criteria</title>
</head>
<body>
	...
	<option value="89">89</option>
                ...
                <tr>
                 ...
                 <tr class="searchContentRowStyle">
                            ...
                            <td class="windowRowContentSearch"><input name="txtStreetName" type="text" value="" id="txtStreetName" style="border-color:Silver;border-width:1px;border-style:Solid;font-family:Arial;font-size:8pt;width:120px;" maxlength="30" /></td>
	...
	<td class="windowRowContentSearch"><input name="txtPortion" type="text" id="txtPortion" style="border-color:Silver;border-width:1px;border-style:Solid;font-family:Arial;font-size:8pt;width:120px;" maxlength="10"/></td>
	<td class="widowRowCaptionSearch ">Deeds Town</td>
	<td class="windowRowContentSearch"><select name="drpDeedsTown" runat="server" id="drpDeedsTown" style="font-family:Arial;font-size:8pt;width:200px;"></select></td>
</tr>
