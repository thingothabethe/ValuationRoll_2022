      ...
      <tr>
       <td>
          <table width="100%" cellpadding="0" cellspacing="0"  border="0">
              ...
              <td valign="top">
                ...
                <table class="tblInner" width="100%" border="1" cellpadding="0" cellspacing="0" >
                  <tr>
                    ...
                    <td class="tdContaint"><xsl:value-of select="PinDetails/Property/RateNumber"/></td>
                    <td  class="widowRowCaption">Property Description</td>
                    <td class="tdContaint"><xsl:value-of select="PinDetails/Property/PropertyDescription"/></td>
                  </tr>
                  <!--<tr>
                  ...
                  <tr>
                    ...
                    <td class="tdContaint"><xsl:value-of select="PinDetails/Property/Address"/></td>
                    <td  class="widowRowCaption">Registered Extent (m&#178;)</td>
                    <td class="tdContaint"><xsl:value-of select='format-number(PinDetails/Property/RegisteredExtent, "####,###.##")'/></td>
                  </tr>
                </table>
            ...
            <tr>
              <td  class="windowSubHeader1"><div  style="display:block;cursor:hand; align:center;" onclick="javascript:ToggleDiv('divPropertDetails')">Property Details</div></td>
            </tr>
            ...
            <tr>
              <td  class="windowSubHeader1"><div  style="display:block;cursor:hand; align:center;" onclick="javascript:ToggleDiv('divValuations')">Valuations</div></td>
            </tr>
            ...
            <tr>
              <td  class="windowSubHeader1"><div  style="display:block;cursor:hand; align:center;" onclick="javascript:ToggleDiv('divOwnsers')">Owners</div></td>
            </tr>
            <tr>
              <td valign="top">
